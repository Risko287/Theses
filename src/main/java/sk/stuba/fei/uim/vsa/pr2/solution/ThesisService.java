...
import static sk.stuba.fei.uim.vsa.pr2.solution.ThesisServiceUtils.asDate;
import static sk.stuba.fei.uim.vsa.pr2.solution.ThesisServiceUtils.asLocalDate;
...
public class ThesisService extends AbstractThesisService<Student, Teacher, Thesis> implements PageableThesisService<Student, Teacher, Thesis> {
    ...
    private final sk.stuba.fei.uim.vsa.pr2.solution.ThesisServiceUtils utils;
    ...
    @Override
    public Student createStudent(Long aisId, String name, String email, String password, Integer year, Integer term, String programme) {
        log.info("Creating student with AIS ID " + aisId);
        String finalPassword = Base64.getEncoder().encodeToString(password.getBytes());
        return utils.create(() -> Student.builder()
                .aisId(aisId)
                .name(name)
                .email(email)
    ...
    @Override
    public Teacher createTeacher(Long aisId, String name, String email, String password, String department, String institute) {
        log.info("Creating teacher with AIS ID " + aisId);
        return utils.create(() -> Teacher.builder()
                .aisId(aisId)
                .name(name)
    ...
    public Thesis makeThesisAssignment(Long supervisor, String title, String type, String description) {
        ...
        return utils.create(() ->
        {
            ...
            //TODO: uncomment when teacher is able to see his supervised theses
            //teacher.getSupervisedTheses().add(thesis);
    ...
    public Thesis deleteThesis(Long id) {
        ...
        Teacher teacher = thesis.getSupervisor();
        teacher.getSupervisedTheses().remove(thesis);
