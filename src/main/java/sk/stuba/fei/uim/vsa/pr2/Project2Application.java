...
public class Project2Application {
    ...
    public static void postStart() {
        ...
        thesisService.createStudent(5L, "Hrasko", "prd@prd.sk");
        thesisService.createTeacher(158L, "FERO", "isdfg", "asdf", "dep", "ins");
        thesisService.makeThesisAssignment(158L, "title", "BACHELOR", "desc");
    }
