...
public abstract class AbstractThesisService<S, T, A> implements AutoCloseable {
    ...
    public abstract S createStudent(Long aisId, String name, String email, String password, Integer year, Integer term, String programme);
    ...
    public abstract T createTeacher(Long aisId, String name, String email, String password, String institute, String department);
