...
# Časť 1: JPA Backend
## Funkcionalita
Cieľom tejto časti projektu je implementovať aplikáciu pre správu záverečných prác na vysokej škole. Aplikácia musí zabezpečiť CRUD operácie nad nasledujúcimi entitami: Študent, Pedagóg a Záverečná práca. Medzi týmito entitami musia byť dodržané nasledujúce vzťahy:
...
Druhá časť projektu zahŕňa implementáciu jednoduchej webovej aplikácie, ktorá publikuje REST API podľa definovanej špecifikácie. Aplikácia musí zabezpečiť nasledujúce funkcie:

* CRUD operácie cez publikované webové služby (s výnimkou operácie na aktualizáciu).
...
## Špecifikácia
* Aplikácia musí publikovať REST webové služby podľa dodanej [**OpenAPI 3 špecifikácie**](./src/main/resources/openapi3.spec.yaml).
* Pre komunikáciu použite protokol HTTP/1.1.
